...
class QuestionBank {
    ...
    var list = [Question]() // <- we are creating an array, it will hold the data of type of Question objects
    
    init() { // <- to create a new QuestionBank object; [in this case it's creating the list variable]
